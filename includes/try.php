...
body {
  min-width: 800px;
  background: #7cc2b7;  /* fallback for old browsers */
background: -webkit-linear-gradient(to right, #7cc2b7, #7cc2b7);  /* Chrome 10-25, Safari 5.1-6 */
background: linear-gradient(to right, #7cc2b7, #7cc2b7); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
